...
export class WineItem extends React.Component {
    ...
    render() {
        ...
        return React.createElement(View, { style: styles.container },
            React.createElement(Image, { style: styles.wine_image, source: { uri: this.getImageURL(data) } }),
            React.createElement(View, { style: styles.description_container },
                React.createElement(Text, { style: styles.wine_title }, this.getWineTitle(data)),
                React.createElement(Text, { style: styles.wine_price }, this.getWinePrice(data)),
                React.createElement(Text, { style: styles.percentage }, this.getPercentage(data)),
                React.createElement(Text, { style: styles.description }, this.getDescription(data))));
    }
}
